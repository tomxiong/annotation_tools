#!/usr/bin/env python3
"""
Fixed packaging script for Panoramic Annotation Tool
"""
...
def main():
    ...
    print("=== Panoramic Annotation Tool Packaging Script (Fixed) ===")
    ...
    # Build GUI version with fixed ttk import
    ...
    try:
        print("Running PyInstaller with ttk fix...")
